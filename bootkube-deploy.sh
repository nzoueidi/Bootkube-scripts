...
export CNI_VERSION=version                   ### CNI VERSION                 ###
export HELM_VERSION=version                  ### HELM VERSION                ###
export BOOTKUBE_VERSION=version              ### BOOTKUBE VERSION            ###
export KUBERNETES_VERSION=version            ### KUBERNETES VERSION          ###
export KUBE_HW='eth0'                       ### MODIFY FOR YOUR ENVIRONMENT ###
export NSERVER01='10.3.0.10'                ### DO NOT MODIFY FOR CEPH PV   ###
export NSERVER02='192.168.1.10'             ### MODIFY FOR YOUR ENVIRONMENT ###
export NSERVER03='8.8.8.8'                  ### MODIFY FOR YOUR ENVIRONMENT ###
export NSEARCH01='svc.cluster.local'        ### MODIFY FOR YOUR ENVIRONMENT ###
export NSEARCH02='nzoueidi.com'               ### MODIFY FOR YOUR ENVIRONMENT ###
